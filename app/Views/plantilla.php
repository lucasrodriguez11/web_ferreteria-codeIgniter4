  ...
  <body class="nav-md">
        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="index.html" class="site_title"><i class="fa fa-paw"></i> <span>Ferreter&iacute;a</span></a>
            </div>
    ...
    <div class="div">
        ...
        <footer>
          ...
          <div class="clearfix">Developer Lucas Nahuel</div>
        </footer>
        <!-- /footer content -->
      </div>
    </div>
